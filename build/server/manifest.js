...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-WNhZhI2S.js')),
			__memo(() => import('./chunks/1-CGbyJdIa.js')),
			__memo(() => import('./chunks/2-DJCyo3nu.js')),
			__memo(() => import('./chunks/3-CBjhpASm.js')),
			__memo(() => import('./chunks/4-CEhBCpWa.js')),
			__memo(() => import('./chunks/5-Dqdm1_Ad.js')),
			__memo(() => import('./chunks/6-BtJrEN6_.js')),
			__memo(() => import('./chunks/7-CQYyF0Np.js')),
			__memo(() => import('./chunks/8-BkEv3pOJ.js')),
			__memo(() => import('./chunks/9-DOdqu_mv.js'))
		],
		routes: [
			{
				id: "/",
