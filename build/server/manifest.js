...
return {
	...
	_: {
		client: {start:"_app/immutable/entry/start.e2N2N__e.js",app:"_app/immutable/entry/app.JfwJZyai.js",imports:["_app/immutable/entry/start.e2N2N__e.js","_app/immutable/chunks/Dy7GWlzg.js","_app/immutable/chunks/CB6CgTib.js","_app/immutable/chunks/2pOmLiwD.js","_app/immutable/entry/app.JfwJZyai.js","_app/immutable/chunks/CB6CgTib.js","_app/immutable/chunks/IHki7fMi.js"],stylesheets:[],fonts:[],uses_env_dynamic_public:false},
		nodes: [
			__memo(() => import('./chunks/0-uyaWUaiC.js')),
			__memo(() => import('./chunks/1-ePzN5FlK.js')),
			__memo(() => import('./chunks/2-BSlMoBYk.js')),
			__memo(() => import('./chunks/3-312FNlW9.js')),
			__memo(() => import('./chunks/4-Cko8cuvL.js')),
			__memo(() => import('./chunks/5-lMc8TS76.js')),
			__memo(() => import('./chunks/6-DiwA8uk_.js')),
			__memo(() => import('./chunks/7-B85JUXZ6.js')),
			__memo(() => import('./chunks/8-CDLwZyhv.js')),
			__memo(() => import('./chunks/9-DaM-N_lb.js')),
			__memo(() => import('./chunks/10-VE4u-74e.js')),
			__memo(() => import('./chunks/11-G8Pj8teZ.js')),
			__memo(() => import('./chunks/12-Cw2Tfcrh.js')),
			__memo(() => import('./chunks/13-DElktdMV.js')),
			__memo(() => import('./chunks/14-BKGo_Hty.js')),
			__memo(() => import('./chunks/15-Bu8VQrsi.js')),
			__memo(() => import('./chunks/16-CXwF5OqM.js')),
			__memo(() => import('./chunks/17-BEeChD3R.js')),
			__memo(() => import('./chunks/18-DZbsvY1D.js')),
			__memo(() => import('./chunks/19-DhJAlVkB.js')),
			__memo(() => import('./chunks/20-CvEcAaym.js')),
			__memo(() => import('./chunks/21-DwT4BvvY.js')),
			__memo(() => import('./chunks/22-Dp3tZ_rr.js')),
			__memo(() => import('./chunks/23-D3dwo48v.js')),
			__memo(() => import('./chunks/24-BOI9kUxL.js')),
			__memo(() => import('./chunks/25-63o4_fe5.js')),
			__memo(() => import('./chunks/26-B04KW48q.js')),
			__memo(() => import('./chunks/27-kxJIOWv0.js')),
			__memo(() => import('./chunks/28-BVdW1WD5.js')),
			__memo(() => import('./chunks/29-BtNrQg2V.js')),
			__memo(() => import('./chunks/30-CWIlTuoQ.js')),
			__memo(() => import('./chunks/31-D7YoBi4O.js')),
			__memo(() => import('./chunks/32-BdO-qPkb.js')),
			__memo(() => import('./chunks/33-H2zdPQs7.js')),
			__memo(() => import('./chunks/34-DTmTt8S6.js')),
			__memo(() => import('./chunks/35-BI6fLiZS.js')),
			__memo(() => import('./chunks/36-DC_tW5Ix.js')),
			__memo(() => import('./chunks/37-B5RlBFEd.js')),
			__memo(() => import('./chunks/38-vBHrf02r.js'))
		],
		remotes: {
		...
		routes: [
			...
			{
				id: "/admin/create-home-index",
				pattern: /^\/admin\/create-home-index\/?$/,
				params: [],
			...
			},
			{
				...
				endpoint: __memo(() => import('./chunks/_server-CQWgatR0.js'))
			},
			{
				id: "/admin/edit-deck",
			...
			{
				id: "/admin/edit-home-index",
				pattern: /^\/admin\/edit-home-index\/?$/,
				params: [],
			...
			},
			{
				...
				endpoint: __memo(() => import('./chunks/_server-Ca7d7smk.js'))
			},
			{
				id: "/admin/questions",
			...
			},
			{
				...
				endpoint: __memo(() => import('./chunks/_server-CGF9aJY_.js'))
			},
			{
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-Cl3xrgk8.js'))
			},
			{
				id: "/api/auth/logout",
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-Dm7Vio5u.js'))
			},
			{
				id: "/api/auth/verify",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-DUpeE_So.js'))
			},
			{
				id: "/api/comment",
				pattern: /^\/api\/comment\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-UXOn2ZTQ.js'))
			},
			{
				id: "/api/like",
				pattern: /^\/api\/like\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-CaMchcjR.js'))
			},
			{
				id: "/login",
				pattern: /^\/login\/?$/,
