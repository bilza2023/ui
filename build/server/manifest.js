...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/1-DT_-nVbu.js')),
			__memo(() => import('./chunks/2-ChBOjbDD.js')),
			__memo(() => import('./chunks/3-CBjhpASm.js')),
			__memo(() => import('./chunks/4-CbsrAXj0.js')),
			__memo(() => import('./chunks/5-CqrIwxK8.js')),
			__memo(() => import('./chunks/6-D3CeVBeM.js')),
			__memo(() => import('./chunks/7-Bb5pb2Ir.js')),
			__memo(() => import('./chunks/8-BpK2qsen.js')),
			__memo(() => import('./chunks/9-BunPhARA.js'))
		],
		routes: [
			{
				id: "/",
