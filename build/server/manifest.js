...
return {
	...
	_: {
		client: {start:"_app/immutable/entry/start.zg5SKlqF.js",app:"_app/immutable/entry/app.nR741B67.js",imports:["_app/immutable/entry/start.zg5SKlqF.js","_app/immutable/chunks/Dmb-liVN.js","_app/immutable/chunks/D80x2hTy.js","_app/immutable/chunks/CiQ5ndwq.js","_app/immutable/entry/app.nR741B67.js","_app/immutable/chunks/D80x2hTy.js","_app/immutable/chunks/IHki7fMi.js"],stylesheets:[],fonts:[],uses_env_dynamic_public:false},
		nodes: [
			__memo(() => import('./chunks/0-CVNzeS0W.js')),
			__memo(() => import('./chunks/1-BLTfoM0w.js')),
			__memo(() => import('./chunks/2-DAyxHuFo.js')),
			__memo(() => import('./chunks/3-CXSPlXJg.js')),
			__memo(() => import('./chunks/4-CPUcd0Yn.js')),
			__memo(() => import('./chunks/5-_XW93KaP.js')),
			__memo(() => import('./chunks/6-B0jpB8MO.js')),
			__memo(() => import('./chunks/7-6EGVAdqJ.js')),
			__memo(() => import('./chunks/8-DRmZW-Xk.js')),
			__memo(() => import('./chunks/9-BTSSNe7P.js')),
			__memo(() => import('./chunks/10-DKSBMWDa.js')),
			__memo(() => import('./chunks/11-BSfxoxW1.js')),
			__memo(() => import('./chunks/12-TOVgKQe3.js')),
			__memo(() => import('./chunks/13-CIZJ3ZeZ.js')),
			__memo(() => import('./chunks/14-D2nHZ7TJ.js')),
			__memo(() => import('./chunks/15-DV_VnLxL.js')),
			__memo(() => import('./chunks/16-Ce_GL6aa.js')),
			__memo(() => import('./chunks/17-DKTUmBuZ.js')),
			__memo(() => import('./chunks/18-CV2uqSzt.js')),
			__memo(() => import('./chunks/19-D3AERezt.js')),
			__memo(() => import('./chunks/20-CTMWYLHY.js')),
			__memo(() => import('./chunks/21-N96ddZTn.js')),
			__memo(() => import('./chunks/22-DIyMZrs-.js')),
			__memo(() => import('./chunks/23-DEXqdfPN.js')),
			__memo(() => import('./chunks/24-Bvvd5sEP.js')),
			__memo(() => import('./chunks/25-Cf6sknh6.js')),
			__memo(() => import('./chunks/26-BiMr3FX_.js')),
			__memo(() => import('./chunks/27-UfUgJvkv.js')),
			__memo(() => import('./chunks/28-1NGq6idQ.js')),
			__memo(() => import('./chunks/29-CHMc-5Cw.js')),
			__memo(() => import('./chunks/30-CAx_GYnk.js')),
			__memo(() => import('./chunks/31-BjvlZQRf.js')),
			__memo(() => import('./chunks/32-j5mD89YC.js'))
		],
		remotes: {
		...
		routes: [
			...
			{
				id: "/admin/create-question",
				pattern: /^\/admin\/create-question\/?$/,
				params: [],
				page: { layouts: [0,2,], errors: [1,,], leaf: 7 },
				endpoint: null
			},
			{
				id: "/admin/edit-question",
				pattern: /^\/admin\/edit-question\/?$/,
				params: [],
			...
			},
			{
				...
				endpoint: __memo(() => import('./chunks/_server-DUEyL_Te.js'))
			},
			{
				id: "/admin/workdesk",
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-CPCIFTaW.js'))
			},
			{
				id: "/api/auth/logout",
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-B4ndiLFK.js'))
			},
			{
				id: "/api/auth/verify",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-CCYHB6i4.js'))
			},
			{
				id: "/api/comment",
				pattern: /^\/api\/comment\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-avPU6wP_.js'))
			},
			{
				id: "/api/like",
				pattern: /^\/api\/like\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-CPhrIXVd.js'))
			},
			{
				id: "/login",
				pattern: /^\/login\/?$/,
