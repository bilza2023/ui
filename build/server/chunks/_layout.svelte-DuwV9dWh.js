...
const css = {
  code: ":root{--color-bg:#1E1E1E;--color-surface:#594112;--color-text:#E8D7BD;--color-text-muted:#B5A58B;--color-primary:#C4A77F;--color-primary-text:#1E1E1E}",
  map: `{"version":3,"file":"+layout.svelte","sources":["+layout.svelte"],"sourcesContent":["<!-- src/routes/+layout.svelte -->\\n<style>:root {\\n    --color-bg: #1E1E1E;            /* Page background */\\n    --color-surface: #594112;       /* Card/panel background */\\n    --color-text: #E8D7BD;          /* Main text */\\n    --color-text-muted: #B5A58B;    /* Secondary text */\\n    --color-primary: #C4A77F;       /* Accent: buttons, links */\\n    --color-primary-text: #1E1E1E;  /* Text on primary */\\n  }\\n  \\n  body {\\n    background-color: var(--color-bg);\\n    color: var(--color-text);\\n  }\\n\\n</style>\\n<script>\\n  // import '$lib/styles/themes.css';\\n  import 'katex/dist/katex.min.css';\\n\\n\\n  import \\"../app.css\\";\\n  import { SvelteToast } from '@zerodevx/svelte-toast'\\n   const options = {}\\n\\n\\n\\n<\/script>\\n\\n<SvelteToast {options} />\\n<!-- <slot/> -->\\n\\n<div class=\\" min-h-screen h-full\\">\\n  <slot></slot>\\n  </div>"],"names":[],"mappings":"AACO,KAAM,CACT,UAAU,CAAE,OAAO,CACnB,eAAe,CAAE,OAAO,CACxB,YAAY,CAAE,OAAO,CACrB,kBAAkB,CAAE,OAAO,CAC3B,eAAe,CAAE,OAAO,CACxB,oBAAoB,CAAE,OACxB"}`
};
...
//# sourceMappingURL=_layout.svelte-DuwV9dWh.js.map
