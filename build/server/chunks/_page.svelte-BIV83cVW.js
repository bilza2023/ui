...
import { g as getDeckEnd, f as findSlideIndex } from './player_utility-LjISCiD5.js';
import 'katex';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${``} ${`<div class="flex items-center justify-center h-full svelte-1xbsh5f" data-svelte-h="svelte-1bzuzh0">Load a deck (JSON) to start</div>`} <input type="file" accept=".json,application/json">`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-BIV83cVW.js.map
