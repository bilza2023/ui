...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let sections = {};
  let error = null;
  const allMdFiles = /* @__PURE__ */ Object.assign({ "/src/lib/md/demo.md": () => Promise.resolve().then(() => demo$1).then((m) => m["default"]), "/src/lib/md/mockSyllabus/mockSyllabus-chapter-3-ex3_1-q4.md": () => import("../../../chunks/mockSyllabus-chapter-3-ex3_1-q4.js").then((m) => m["default"]) });
