...
<main class="max-w-3xl mx-auto py-10 px-6">
  ...
  <ul class="space-y-6">
    ...
    <li class="bg-[#f8f2dd] p-5 rounded-lg shadow hover:shadow-md transition">
      ...
      <p class="text-sm text-gray-500 mt-1">AI Foundation Course Brocheure.</p>
    </li>
    ...
    <li class="bg-[#f8f2dd] p-5 rounded-lg shadow hover:shadow-md transition">
      <a href="/blog/be-part-of-ai-revolution.html" class="text-2xl text-[#023047] font-semibold hover:underline">
        📢 Be Part of AI Revolution
      </a>
      <p class="text-sm text-gray-500 mt-1">Why Learning AI is a must Now.</p>
    </li>
